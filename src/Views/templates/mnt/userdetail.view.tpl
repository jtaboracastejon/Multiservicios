                ...
                <form action="index.php?page=mnt-userdetail&mode={{mode}}&iduserdetail={{iduserdetail}}" method="post"
                    ...
                    <p class="pl-10 pt-10 text-black-400 text-xl font-bold lg:text-2xl mb-2">{{mode_dsc}}
                        ...
                        <input type="hidden" name="usercod" id="usercod" {{if readOnly}}disabled{{endif readOnly}}
                            value="{{usercod}}" class="form-input !ml-10 !w-[40rem] !text-sm"
                    ...
                    <!--<fieldset>
                        ...
                        <label for="phonenumber" class="form-label !ml-10 !mt-2 !font-semibold !text-sm">Numero de telefono</label>
                        ...
                        <label class="form-label !ml-10 !mt-2 !font-semibold !text-sm" for="select">Seleccione zona de trabajo</label>
                        <select name="idworkzone" id="idworkzone" {{if readOnly}} disabled {{endif readOnly}} class="form-select !ml-10 !w-[25rem] !text-sm">
                           {{foreach workzones}}
                            <option value="{{idworkzone}}"{{selected}}>{{department}},{{municipality}}</option>
                           {{endfor workzones}}
                        </select>

                        <label for="imgprofile" class="form-label !ml-10 !mt-2 !font-semibold !text-sm">Imagen de perfil</label>
                        <input type="text" name="imgprofile" id="imgprofile" {{if readOnly}}disabled{{endif readOnly}}
                            value="{{imgprofile}}" class="form-input !ml-10 !w-[40rem] !text-sm"
                            placeholder="Ingresar imagen">

                        <label for="imgportada" class="form-label !ml-10 !mt-2 !font-semibold !text-sm">Imagen de portada</label>
                        <input type="text" name="imgportada" id="imgportada" {{if readOnly}}disabled{{endif readOnly}}
