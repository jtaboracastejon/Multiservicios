...
<div class="grid grid-cols-3 gap-4 p-10">
    {{foreach servicios}}
    <a href="index.php?page=Services-Search&service={{idservice}}" class="js-target shadow-lg bg-cover bg-center rounded-lg h-36" style="background-image: url('{{imagepath}}');">
