    ...
    <div class="p-10 bg-multiLightGray col-span-4" id="barrelContainer">
        <div class="bg-white rounded-lg p-10">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-left">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-5 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <a href="index.php?page=orders_providerdash&idorder={{idorder}}">Ver detalles</a>
                                            </div>
                                            {{endif isEnProceso}}
                                        </div>
                                    </td>
                    ...
                    <div class="inline-flex items-center">
                        <a href="index.php?page=orders_providerdash"><i class="fa-solid fa-chevron-left -ml-5"></i> </a>
                        <p class="text-black-400 text-xl font-bold lg:text-2xl">Detalles de la orden</p>
                    </div>
                    <div class="grid grid-rows-1 m-5 rounded-lg h-auto bg-white">
                        <div class="overflow-x-auto relative rounded-lg">
                        <form class="text-justify">
                            ...
                            {{if readyToFinish}}
                            <button type="button" class="form-successButton !ml-10" onclick="finalizarOrder('providerdash')">Finalizar Orden</button>
                            {{endif readyToFinish}}

                            {{ifnot readyToFinish}}
                            <p>El cliente debe de aceptar la orden para poder finalizarla</p>
                             <button type="button" class="form-secondaryButton !ml-10" disabled>Finalizar Orden</button>
                            {{endifnot readyToFinish}}
                            <button type="button" class="form-dangerButton !mb-4" onclick="anularOrder('providerdash')">Anular Orden</button>
