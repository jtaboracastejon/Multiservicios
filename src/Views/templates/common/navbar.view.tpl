<div class="bg-black bg-opacity-80" style="box-shadow:-5px 4px 5px 0 rgba(0,0,0,0.8);">
    <nav class="relative px-4 z-10 py-4 flex justify-between items-center ">
        ...
        <a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-4 border-solid border-2 border-white hover:bg-gray-300 hover:bg-opacity-40 text-sm text-white font-bold rounded-full transition duration-200" href="#" onclick="modalHandler1(true, 'modalLogin')">Iniciar Sesión</a>
        <a class="hidden lg:inline-block py-2 px-6 bg-multiDarkBlue border-solid border-2 border-multiDarkBlue hover:bg-blue-600 hover:border-blue-600 text-sm text-white font-bold rounded-full transition duration-200" href="#" onclick="modalHandler1(true, 'modal1')">Unirse</a>
    </nav>
    <div class="navbar-menu relative z-50 hidden">
        ...
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <div>
                <ul>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-white hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Home</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-white hover:bg-blue-50 hover:text-blue-600 rounded" href="#">About Us</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-white hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Services</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-white hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Pricing</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-white hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="mt-auto">
